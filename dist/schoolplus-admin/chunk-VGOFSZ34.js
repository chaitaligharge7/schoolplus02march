...
var CertificateService = class _CertificateService {
  ...
  updateCertificate(certificateId, certificateData) {
    return this.http.post(`${environment.apiUrl}/certificates/update.php`, __spreadValues({
...
// src/app/modules/certificates/certificate-list/certificate-list.component.ts
function CertificateListComponent_div_13_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 9)(1, "button", 10);
    \u0275\u0275listener("click", function CertificateListComponent_div_13_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.generateCertificate(ctx_r1.selectedRowId));
    });
    \u0275\u0275element(2, "i", 11);
    \u0275\u0275text(3, " Generate Certificate ");
    \u0275\u0275elementEnd()();
  }
}
var CertificateListComponent = class _CertificateListComponent {
  certificateService;
  dialogService;
  toastService;
  exportService;
  ...
  constructor(certificateService, dialogService, toastService, exportService, router) {
  ...
  onCertificateTypeChange(type) {
    this.certificateType = type || void 0;
    this.pagination.page = 1;
    this.loadCertificates();
  }
  generateCertificate(certificateId) {
  ...
  static \u0275fac = function CertificateListComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _CertificateListComponent)(\u0275\u0275directiveInject(CertificateService), \u0275\u0275directiveInject(DialogService), \u0275\u0275directiveInject(ToastService), \u0275\u0275directiveInject(ExportService), \u0275\u0275directiveInject(Router));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CertificateListComponent, selectors: [["app-certificate-list"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 14, vars: 18, consts: [[1, "certificate-list-container"], [1, "page-header"], [1, "page-title"], [1, "page-subtitle"], [1, "filter-panel", "header-dropdowns"], [1, "filter-group"], ["placeholder", "Search or select certificate type", 3, "ngModelChange", "valueChange", "options", "ngModel"], [3, "pageChange", "pageSizeChange", "searchChange", "sortChange", "dateFilterChange", "rowSelect", "refresh", "addClick", "editClick", "deleteClick", "viewClick", "printClick", "exportClick", "filterToggle", "data", "columns", "pagination", "loading", "selectedRowId", "rowIdKey", "addRoute", "addLabel", "searchPlaceholder", "enableExport", "enableDateFilter", "showViewButton", "showPrintButton"], ["class", "generate-action", 4, "ngIf"], [1, "generate-action"], ["title", "Generate Certificate", 1, "btn", "btn-primary", 3, "click"], [1, "bi", "bi-download"]], template: function CertificateListComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "div")(3, "h1", 2);
      \u0275\u0275text(4, "Certificates");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(5, "p", 3);
      \u0275\u0275text(6, "Manage and generate student certificates");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(7, "div", 4)(8, "div", 5)(9, "label");
      \u0275\u0275text(10, "Certificate Type:");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(11, "app-search-select", 6);
      \u0275\u0275twoWayListener("ngModelChange", function CertificateListComponent_Template_app_search_select_ngModelChange_11_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.certificateType, $event) || (ctx.certificateType = $event);
        return $event;
      });
      \u0275\u0275listener("valueChange", function CertificateListComponent_Template_app_search_select_valueChange_11_listener($event) {
        return ctx.onCertificateTypeChange($event);
      });
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(12, "app-enhanced-table", 7);
      \u0275\u0275listener("pageChange", function CertificateListComponent_Template_app_enhanced_table_pageChange_12_listener($event) {
        return ctx.onPageChange($event);
      })("pageSizeChange", function CertificateListComponent_Template_app_enhanced_table_pageSizeChange_12_listener($event) {
        return ctx.onPageSizeChange($event);
      })("searchChange", function CertificateListComponent_Template_app_enhanced_table_searchChange_12_listener($event) {
        return ctx.onSearchChange($event);
      })("sortChange", function CertificateListComponent_Template_app_enhanced_table_sortChange_12_listener($event) {
        return ctx.onSortChange($event);
      })("dateFilterChange", function CertificateListComponent_Template_app_enhanced_table_dateFilterChange_12_listener($event) {
        return ctx.onDateFilterChange($event);
      })("rowSelect", function CertificateListComponent_Template_app_enhanced_table_rowSelect_12_listener($event) {
        return ctx.onRowSelect($event);
      })("refresh", function CertificateListComponent_Template_app_enhanced_table_refresh_12_listener() {
        return ctx.onRefresh();
      })("addClick", function CertificateListComponent_Template_app_enhanced_table_addClick_12_listener() {
        return ctx.onAdd();
      })("editClick", function CertificateListComponent_Template_app_enhanced_table_editClick_12_listener($event) {
        return ctx.onEdit($event);
      })("deleteClick", function CertificateListComponent_Template_app_enhanced_table_deleteClick_12_listener($event) {
        return ctx.onDelete($event);
      })("viewClick", function CertificateListComponent_Template_app_enhanced_table_viewClick_12_listener($event) {
        return ctx.onView($event);
      })("printClick", function CertificateListComponent_Template_app_enhanced_table_printClick_12_listener($event) {
        return ctx.onPrintCertificate($event);
      })("exportClick", function CertificateListComponent_Template_app_enhanced_table_exportClick_12_listener($event) {
        return ctx.onExportClick($event);
      })("filterToggle", function CertificateListComponent_Template_app_enhanced_table_filterToggle_12_listener($event) {
        return ctx.onFilterToggle($event);
      });
      \u0275\u0275elementEnd();
      \u0275\u0275template(13, CertificateListComponent_div_13_Template, 4, 0, "div", 8);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      let tmp_16_0;
      ...
      \u0275\u0275advance(4);
      \u0275\u0275property("options", ctx.certificateTypeOptions);
      \u0275\u0275twoWayProperty("ngModel", ctx.certificateType);
      \u0275\u0275advance();
      \u0275\u0275property("data", ctx.certificates)("columns", ctx.columns)("pagination", ctx.pagination)("loading", ctx.loading)("selectedRowId", ctx.selectedRowId)("rowIdKey", "certificate_id")("addRoute", "/app/certificates/create")("addLabel", "Create Certificate")("searchPlaceholder", "Search by student name, certificate type...")("enableExport", true)("enableDateFilter", true)("showViewButton", true)("showPrintButton", true);
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ctx.selectedRowId && ((tmp_16_0 = ctx.getSelectedCertificate()) == null ? null : tmp_16_0.status) === "Pending");
    }
  }, dependencies: [CommonModule, NgIf, FormsModule, NgControlStatus, NgModel, RouterModule, EnhancedTableComponent, SearchSelectComponent], styles: ["\n\n.certificate-list-container[_ngcontent-%COMP%] {\n  width: 100%;\n  padding: 0;\n}\n@media (max-width: 768px) {\n  .certificate-list-container[_ngcontent-%COMP%] {\n    padding: 12px 16px;\n  }\n}\n@media (max-width: 480px) {\n  .certificate-list-container[_ngcontent-%COMP%] {\n    padding: 8px 12px;\n  }\n}\n.certificate-list-container[_ngcontent-%COMP%]   .page-header[_ngcontent-%COMP%] {\n  margin-top: 0;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  flex-wrap: wrap;\n  gap: var(--spacing-md);\n}\n.certificate-list-container[_ngcontent-%COMP%]   .page-header[_ngcontent-%COMP%]   .page-title[_ngcontent-%COMP%] {\n  font-size: var(--font-size-xl);\n}\n@media (max-width: 768px) {\n  .certificate-list-container[_ngcontent-%COMP%]   .page-header[_ngcontent-%COMP%] {\n    flex-direction: column;\n    align-items: flex-start;\n  }\n}\n.certificate-list-container[_ngcontent-%COMP%]   .additional-filters[_ngcontent-%COMP%] {\n  display: flex;\n  gap: var(--spacing-md);\n  margin-bottom: var(--spacing-lg);\n  padding: var(--spacing-md);\n  background: var(--bg-secondary);\n  border-radius: var(--radius-md);\n  flex-wrap: wrap;\n  align-items: end;\n}\n.certificate-list-container[_ngcontent-%COMP%]   .additional-filters[_ngcontent-%COMP%]   .filter-group[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: var(--spacing-xs);\n  min-width: 150px;\n}\n.certificate-list-container[_ngcontent-%COMP%]   .additional-filters[_ngcontent-%COMP%]   .filter-group[_ngcontent-%COMP%]   label[_ngcontent-%COMP%] {\n  font-size: var(--font-size-sm);\n  font-weight: 500;\n  color: var(--text-secondary);\n}\n.certificate-list-container[_ngcontent-%COMP%]   .additional-filters[_ngcontent-%COMP%]   .filter-group[_ngcontent-%COMP%]   .form-control[_ngcontent-%COMP%] {\n  padding: var(--spacing-sm) var(--spacing-md);\n  border: 1px solid var(--border-color);\n  border-radius: var(--radius-md);\n  background: var(--bg-primary);\n  color: var(--text-primary);\n  font-size: var(--font-size-sm);\n  transition: all var(--transition-base);\n}\n.certificate-list-container[_ngcontent-%COMP%]   .additional-filters[_ngcontent-%COMP%]   .filter-group[_ngcontent-%COMP%]   .form-control[_ngcontent-%COMP%]:focus {\n  outline: none;\n  border-color: var(--primary-color);\n  box-shadow: 0 0 0 3px rgba(37, 99, 235, 0.1);\n}\n.certificate-list-container[_ngcontent-%COMP%]   .generate-action[_ngcontent-%COMP%] {\n  margin-top: var(--spacing-md);\n  padding: var(--spacing-md);\n  background: var(--bg-secondary);\n  border-radius: var(--radius-md);\n  display: flex;\n  justify-content: center;\n}\n/*# sourceMappingURL=certificate-list.component.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CertificateListComponent, { className: "CertificateListComponent", filePath: "src\\app\\modules\\certificates\\certificate-list\\certificate-list.component.ts", lineNumber: 19 });
})();

// src/app/modules/certificates/certificate-create/certificate-create.component.ts
function CertificateCreateComponent_option_19_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("value", student_r1.student_id);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2(" ", student_r1.full_name, " - ", student_r1.admission_number, " ");
  }
}
function CertificateCreateComponent_span_51_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1("", ctx_r1.isEditMode ? "Update" : "Create", " Certificate");
  }
}
function CertificateCreateComponent_span_52_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275element(1, "span", 26);
    \u0275\u0275text(2, " Saving... ");
...
var CertificateCreateComponent = class _CertificateCreateComponent {
  fb;
  certificateService;
  studentService;
  router;
  ...
  isSaving = false;
  students = [];
  constructor(fb, certificateService, studentService, router, route) {
    this.fb = fb;
    this.certificateService = certificateService;
  ...
  static \u0275fac = function CertificateCreateComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _CertificateCreateComponent)(\u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(CertificateService), \u0275\u0275directiveInject(StudentService), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(ActivatedRoute));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CertificateCreateComponent, selectors: [["app-certificate-create"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 53, vars: 8, consts: [[1, "certificate-create-container"], [1, "page-header"], [1, "page-title"], [1, "page-subtitle"], [1, "btn", "btn-outline", 3, "click"], [1, "bi", "bi-arrow-left"], [1, "form-card"], [3, "ngSubmit", "formGroup"], [1, "form-row"], [1, "form-group"], ["formControlName", "student_id", "required", "", 1, "form-control"], [3, "value"], [3, "value", 4, "ngFor", "ngForOf"], ["formControlName", "certificate_type", "required", "", 1, "form-control"], ["value", "Transfer Certificate"], ["value", "Character Certificate"], ["value", "Bonafide Certificate"], ["value", "Migration Certificate"], ["value", "Other"], ["type", "text", "formControlName", "certificate_number", "placeholder", "Auto-generated if left empty", 1, "form-control"], ["type", "date", "formControlName", "issue_date", "required", "", 1, "form-control"], ["formControlName", "certificate_content", "rows", "6", "placeholder", "Enter certificate content/details...", 1, "form-control"], [1, "form-actions"], ["type", "button", 1, "btn", "btn-outline", 3, "click"], ["type", "submit", 1, "btn", "btn-primary", 3, "disabled"], [4, "ngIf"], [1, "spinner-small"]], template: function CertificateCreateComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "div")(3, "h1", 2);
      \u0275\u0275text(4);
      \u0275\u0275elementEnd();
...
//# sourceMappingURL=chunk-VGOFSZ34.js.map
