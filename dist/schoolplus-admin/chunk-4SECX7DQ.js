...
var NoticeService = class _NoticeService {
  http;
  constructor(http) {
    this.http = http;
  }
  ...
  static \u0275fac = function NoticeService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _NoticeService)(\u0275\u0275inject(HttpClient));
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _NoticeService, factory: _NoticeService.\u0275fac, providedIn: "root" });
};

// src/app/modules/notices/notice-list/notice-list.component.ts
function NoticeListComponent_div_10_option_36_Template(rf, ctx) {
  if (rf & 1) {
...
function NoticeListComponent_div_10_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 10)(1, "div", 11)(2, "div", 12)(3, "label");
    \u0275\u0275text(4, "Notice Type:");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "select", 13);
    \u0275\u0275twoWayListener("ngModelChange", function NoticeListComponent_div_10_Template_select_ngModelChange_5_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.noticeType, $event) || (ctx_r1.noticeType = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("change", function NoticeListComponent_div_10_Template_select_change_5_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onNoticeTypeChange(ctx_r1.noticeType));
    });
    \u0275\u0275elementStart(6, "option", 14);
    \u0275\u0275text(7, "All Types");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(8, "option", 15);
    \u0275\u0275text(9, "General");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "option", 16);
    \u0275\u0275text(11, "Exam");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275twoWayListener("ngModelChange", function NoticeListComponent_div_10_Template_select_ngModelChange_19_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.targetAudience, $event) || (ctx_r1.targetAudience = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("change", function NoticeListComponent_div_10_Template_select_change_19_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onTargetAudienceChange(ctx_r1.targetAudience));
    });
    ...
    \u0275\u0275twoWayListener("ngModelChange", function NoticeListComponent_div_10_Template_select_ngModelChange_33_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.classId, $event) || (ctx_r1.classId = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("change", function NoticeListComponent_div_10_Template_select_change_33_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onClassChange(ctx_r1.classId));
    });
    \u0275\u0275elementStart(34, "option", 14);
    \u0275\u0275text(35, "All Classes");
    \u0275\u0275elementEnd();
    \u0275\u0275template(36, NoticeListComponent_div_10_option_36_Template, 2, 2, "option", 23);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275advance(5);
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.noticeType);
    \u0275\u0275advance();
    \u0275\u0275property("value", void 0);
    \u0275\u0275advance(13);
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.targetAudience);
    \u0275\u0275advance();
    \u0275\u0275property("value", void 0);
    \u0275\u0275advance(13);
...
var NoticeListComponent = class _NoticeListComponent {
  noticeService;
  classService;
  dialogService;
  toastService;
  ...
  classId;
  showFilters = false;
  constructor(noticeService, classService, dialogService, toastService, exportService, router) {
  ...
  onNoticeTypeChange(type) {
    this.noticeType = type || void 0;
    this.pagination.page = 1;
    this.loadNotices();
  }
  onTargetAudienceChange(audience) {
    this.targetAudience = audience || void 0;
    this.pagination.page = 1;
    this.loadNotices();
  }
  ...
  static \u0275fac = function NoticeListComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _NoticeListComponent)(\u0275\u0275directiveInject(NoticeService), \u0275\u0275directiveInject(ClassService), \u0275\u0275directiveInject(DialogService), \u0275\u0275directiveInject(ToastService), \u0275\u0275directiveInject(ExportService), \u0275\u0275directiveInject(Router));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NoticeListComponent, selectors: [["app-notice-list"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 12, vars: 12, consts: [[1, "notice-list-container"], [1, "page-header"], [1, "header-content"], [1, "header-icon"], [1, "bi", "bi-megaphone"], [1, "header-text"], [1, "page-title"], [1, "page-subtitle"], ["class", "filters-panel", 3, "expanded", 4, "ngIf"], [3, "pageChange", "pageSizeChange", "searchChange", "sortChange", "dateFilterChange", "rowSelect", "refresh", "addClick", "editClick", "deleteClick", "exportClick", "filterToggle", "data", "columns", "pagination", "loading", "selectedRowId", "rowIdKey", "addRoute", "addLabel", "searchPlaceholder", "enableExport", "enableDateFilter"], [1, "filters-panel"], [1, "filters-row"], [1, "filter-item"], [1, "form-control", 3, "ngModelChange", "change", "ngModel"], [3, "value"], ["value", "General"], ["value", "Exam"], ["value", "Fee"], ["value", "Event"], ["value", "All"], ["value", "Students"], ["value", "Teachers"], ["value", "Parents"], [3, "value", 4, "ngFor", "ngForOf"]], template: function NoticeListComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "div", 2)(3, "div", 3);
      \u0275\u0275element(4, "i", 4);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(5, "div", 5)(6, "h1", 6);
      \u0275\u0275text(7, "Notices & Announcements");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(8, "p", 7);
      \u0275\u0275text(9, "Manage school notices and announcements");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275template(10, NoticeListComponent_div_10_Template, 37, 9, "div", 8);
      \u0275\u0275elementStart(11, "app-enhanced-table", 9);
      \u0275\u0275listener("pageChange", function NoticeListComponent_Template_app_enhanced_table_pageChange_11_listener($event) {
        return ctx.onPageChange($event);
      })("pageSizeChange", function NoticeListComponent_Template_app_enhanced_table_pageSizeChange_11_listener($event) {
        return ctx.onPageSizeChange($event);
      })("searchChange", function NoticeListComponent_Template_app_enhanced_table_searchChange_11_listener($event) {
        return ctx.onSearchChange($event);
      })("sortChange", function NoticeListComponent_Template_app_enhanced_table_sortChange_11_listener($event) {
        return ctx.onSortChange($event);
      })("dateFilterChange", function NoticeListComponent_Template_app_enhanced_table_dateFilterChange_11_listener($event) {
        return ctx.onDateFilterChange($event);
      })("rowSelect", function NoticeListComponent_Template_app_enhanced_table_rowSelect_11_listener($event) {
        return ctx.onRowSelect($event);
      })("refresh", function NoticeListComponent_Template_app_enhanced_table_refresh_11_listener() {
        return ctx.onRefresh();
      })("addClick", function NoticeListComponent_Template_app_enhanced_table_addClick_11_listener() {
        return ctx.onAdd();
      })("editClick", function NoticeListComponent_Template_app_enhanced_table_editClick_11_listener($event) {
        return ctx.onEdit($event);
      })("deleteClick", function NoticeListComponent_Template_app_enhanced_table_deleteClick_11_listener($event) {
        return ctx.onDelete($event);
      })("exportClick", function NoticeListComponent_Template_app_enhanced_table_exportClick_11_listener($event) {
        return ctx.onExportClick($event);
      })("filterToggle", function NoticeListComponent_Template_app_enhanced_table_filterToggle_11_listener($event) {
...
function NoticeCreateComponent_option_74_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 30);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("value", sec_r2.section_id);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(sec_r2.section_name);
  }
}
function NoticeCreateComponent_div_100_i_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "i", 55);
  }
}
function NoticeCreateComponent_div_100_img_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "img", 56);
  }
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext(2);
    \u0275\u0275property("src", ctx_r3.filePreview, \u0275\u0275sanitizeUrl);
  }
}
function NoticeCreateComponent_div_100_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 46)(1, "div", 47);
    \u0275\u0275template(2, NoticeCreateComponent_div_100_i_2_Template, 1, 0, "i", 48)(3, NoticeCreateComponent_div_100_img_3_Template, 1, 1, "img", 49);
    ...
    \u0275\u0275listener("click", function NoticeCreateComponent_div_100_Template_button_click_9_listener() {
      \u0275\u0275restoreView(_r3);
  ...
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275property("ngIf", !ctx_r3.filePreview);
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r3.filePreview);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r3.selectedFile.name);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("", (ctx_r3.selectedFile.size / 1024).toFixed(2), " KB");
  }
}
function NoticeCreateComponent_span_105_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1("", ctx_r3.isEditMode ? "Update" : "Create", " Notice");
  }
}
function NoticeCreateComponent_span_106_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275element(1, "span", 57);
    \u0275\u0275text(2);
...
var NoticeCreateComponent = class _NoticeCreateComponent {
  fb;
  noticeService;
  classService;
  router;
  ...
  selectedFile = null;
  filePreview = null;
  constructor(fb, noticeService, classService, router, route) {
    this.fb = fb;
    this.noticeService = noticeService;
    this.classService = classService;
    this.router = router;
    ...
    this.noticeForm = this.fb.group({
      ...
      class_id: [null],
      section_id: [null],
      notice_date: [(/* @__PURE__ */ new Date()).toISOString().split("T")[0], Validators.required],
      is_important: [false]
    });
  }
  ngOnInit() {
      ...
      next: (response) => {
        ...
        if (n) {
          this.noticeForm.patchValue({
            ...
            notice_date: n.notice_date ? n.notice_date.split(" ")[0] : (/* @__PURE__ */ new Date()).toISOString().split("T")[0],
            is_important: !!n.is_important
          });
          if (n.class_id)
            this.loadSections(n.class_id);
        }
      }
    });
  }
  ...
  static \u0275fac = function NoticeCreateComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _NoticeCreateComponent)(\u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(NoticeService), \u0275\u0275directiveInject(ClassService), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(ActivatedRoute));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _NoticeCreateComponent, selectors: [["app-notice-create"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 107, vars: 24, consts: [[1, "notice-create-container"], [1, "page-header"], [1, "page-title"], [1, "page-subtitle"], [1, "btn", "btn-outline", 3, "click"], [1, "bi", "bi-x-circle"], [1, "form-card"], [3, "ngSubmit", "formGroup"], [1, "form-sections"], [1, "form-section"], [1, "section-title"], [1, "form-grid"], [1, "form-group", "full-width"], [1, "required"], ["type", "text", "formControlName", "notice_title", "placeholder", "Enter notice title", 1, "form-control"], ["class", "invalid-feedback", 4, "ngIf"], ["formControlName", "notice_content", "rows", "6", "placeholder", "Enter notice content", 1, "form-control"], [1, "form-group"], ["formControlName", "notice_type", 1, "form-control"], ["value", "General"], ["value", "Exam"], ["value", "Fee"], ["value", "Event"], ["value", "Holiday"], ["formControlName", "target_audience", 1, "form-control"], ["value", "All"], ["value", "Students"], ["value", "Teachers"], ["value", "Parents"], ["formControlName", "class_id", 1, "form-control"], [3, "value"], [3, "value", 4, "ngFor", "ngForOf"], ["formControlName", "section_id", 1, "form-control", 3, "disabled"], ["type", "date", "formControlName", "notice_date", 1, "form-control"], [1, "checkbox-label"], ["type", "checkbox", "formControlName", "is_important", 1, "checkbox-input"], [1, "file-upload-area"], ["type", "file", "id", "fileInput", "accept", "image/*,.pdf", 1, "file-input", 3, "change"], ["for", "fileInput", 1, "file-upload-label"], [1, "bi", "bi-cloud-upload"], ["class", "file-preview", 4, "ngIf"], [1, "form-actions"], ["type", "button", 1, "btn", "btn-outline", 3, "click"], ["type", "submit", 1, "btn", "btn-primary", 3, "disabled"], [4, "ngIf"], [1, "invalid-feedback"], [1, "file-preview"], [1, "preview-content"], ["class", "bi bi-file-earmark", 4, "ngIf"], ["alt", "Preview", "class", "preview-image", 3, "src", 4, "ngIf"], [1, "file-info"], [1, "file-name"], [1, "file-size"], ["type", "button", "title", "Remove", 1, "btn-icon", "btn-delete", 3, "click"], [1, "bi", "bi-x"], [1, "bi", "bi-file-earmark"], ["alt", "Preview", 1, "preview-image", 3, "src"], [1, "spinner-small"]], template: function NoticeCreateComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275listener("click", function NoticeCreateComponent_Template_button_click_7_listener() {
        return ctx.cancel();
      });
      \u0275\u0275element(8, "i", 5);
      \u0275\u0275text(9, " Cancel ");
      ...
      \u0275\u0275listener("ngSubmit", function NoticeCreateComponent_Template_form_ngSubmit_11_listener() {
        return ctx.onSubmit();
      });
      \u0275\u0275elementStart(12, "div", 8)(13, "div", 9)(14, "h3", 10);
      \u0275\u0275text(15, "Notice Details");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(16, "div", 11)(17, "div", 12)(18, "label");
      \u0275\u0275text(19, "Notice Title ");
      \u0275\u0275elementStart(20, "span", 13);
      \u0275\u0275text(21, "*");
      \u0275\u0275elementEnd()();
      \u0275\u0275element(22, "input", 14);
      \u0275\u0275template(23, NoticeCreateComponent_div_23_Template, 2, 0, "div", 15);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(24, "div", 12)(25, "label");
      \u0275\u0275text(26, "Notice Content ");
      \u0275\u0275elementStart(27, "span", 13);
      \u0275\u0275text(28, "*");
      \u0275\u0275elementEnd()();
      \u0275\u0275element(29, "textarea", 16);
      \u0275\u0275template(30, NoticeCreateComponent_div_30_Template, 2, 0, "div", 15);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(31, "div", 17)(32, "label");
      \u0275\u0275text(33, "Notice Type ");
      ...
      \u0275\u0275text(46, "Holiday");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(47, "div", 17)(48, "label");
      \u0275\u0275text(49, "Target Audience ");
      ...
      \u0275\u0275text(66, "All Classes");
      \u0275\u0275elementEnd();
      \u0275\u0275template(67, NoticeCreateComponent_option_67_Template, 2, 2, "option", 31);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(68, "div", 17)(69, "label");
      \u0275\u0275text(70, "Section");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(71, "select", 32)(72, "option", 30);
      \u0275\u0275text(73, "All Sections");
      \u0275\u0275elementEnd();
      \u0275\u0275template(74, NoticeCreateComponent_option_74_Template, 2, 2, "option", 31);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(75, "div", 17)(76, "label");
      \u0275\u0275text(77, "Notice Date ");
      \u0275\u0275elementStart(78, "span", 13);
      \u0275\u0275text(79, "*");
      \u0275\u0275elementEnd()();
      \u0275\u0275element(80, "input", 33);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(81, "div", 17)(82, "label", 34);
      \u0275\u0275element(83, "input", 35);
      \u0275\u0275elementStart(84, "span");
      \u0275\u0275text(85, "Mark as Important");
      \u0275\u0275elementEnd()()()()();
      \u0275\u0275elementStart(86, "div", 9)(87, "h3", 10);
      \u0275\u0275text(88, "Attachment (Optional)");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(89, "div", 12)(90, "label");
      \u0275\u0275text(91, "Upload File");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(92, "div", 36)(93, "input", 37);
      \u0275\u0275listener("change", function NoticeCreateComponent_Template_input_change_93_listener($event) {
        return ctx.onFileSelected($event);
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(94, "label", 38);
      \u0275\u0275element(95, "i", 39);
      \u0275\u0275elementStart(96, "span");
      \u0275\u0275text(97, "Click to upload or drag and drop");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(98, "small");
      \u0275\u0275text(99, "Images (JPEG, PNG, GIF) or PDF (Max 5MB)");
      \u0275\u0275elementEnd()()();
      \u0275\u0275template(100, NoticeCreateComponent_div_100_Template, 11, 4, "div", 40);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(101, "div", 41)(102, "button", 42);
      \u0275\u0275listener("click", function NoticeCreateComponent_Template_button_click_102_listener() {
        return ctx.cancel();
      });
      \u0275\u0275text(103, "Cancel");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(104, "button", 43);
      \u0275\u0275template(105, NoticeCreateComponent_span_105_Template, 2, 1, "span", 44)(106, NoticeCreateComponent_span_106_Template, 3, 1, "span", 44);
      \u0275\u0275elementEnd()()()()();
    }
    if (rf & 2) {
      let tmp_3_0;
      ...
      let tmp_14_0;
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(ctx.isEditMode ? "Edit Notice" : "Create Notice");
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate(ctx.isEditMode ? "Update notice or announcement" : "Create a new notice or announcement");
      \u0275\u0275advance(5);
      \u0275\u0275property("formGroup", ctx.noticeForm);
      \u0275\u0275advance(11);
      \u0275\u0275classProp("is-invalid", ((tmp_3_0 = ctx.noticeForm.get("notice_title")) == null ? null : tmp_3_0.invalid) && ((tmp_3_0 = ctx.noticeForm.get("notice_title")) == null ? null : tmp_3_0.touched));
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ((tmp_4_0 = ctx.noticeForm.get("notice_title")) == null ? null : tmp_4_0.invalid) && ((tmp_4_0 = ctx.noticeForm.get("notice_title")) == null ? null : tmp_4_0.touched));
      \u0275\u0275advance(6);
      \u0275\u0275classProp("is-invalid", ((tmp_5_0 = ctx.noticeForm.get("notice_content")) == null ? null : tmp_5_0.invalid) && ((tmp_5_0 = ctx.noticeForm.get("notice_content")) == null ? null : tmp_5_0.touched));
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ((tmp_6_0 = ctx.noticeForm.get("notice_content")) == null ? null : tmp_6_0.invalid) && ((tmp_6_0 = ctx.noticeForm.get("notice_content")) == null ? null : tmp_6_0.touched));
      \u0275\u0275advance(6);
      \u0275\u0275classProp("is-invalid", ((tmp_7_0 = ctx.noticeForm.get("notice_type")) == null ? null : tmp_7_0.invalid) && ((tmp_7_0 = ctx.noticeForm.get("notice_type")) == null ? null : tmp_7_0.touched));
      \u0275\u0275advance(16);
      \u0275\u0275classProp("is-invalid", ((tmp_8_0 = ctx.noticeForm.get("target_audience")) == null ? null : tmp_8_0.invalid) && ((tmp_8_0 = ctx.noticeForm.get("target_audience")) == null ? null : tmp_8_0.touched));
      \u0275\u0275advance(13);
      \u0275\u0275property("value", null);
      \u0275\u0275advance(2);
      \u0275\u0275property("ngForOf", ctx.classes);
      \u0275\u0275advance(4);
      \u0275\u0275property("disabled", !((tmp_11_0 = ctx.noticeForm.get("class_id")) == null ? null : tmp_11_0.value));
      \u0275\u0275advance();
      \u0275\u0275property("value", null);
      \u0275\u0275advance(2);
      \u0275\u0275property("ngForOf", ctx.sections);
      \u0275\u0275advance(6);
      \u0275\u0275classProp("is-invalid", ((tmp_14_0 = ctx.noticeForm.get("notice_date")) == null ? null : tmp_14_0.invalid) && ((tmp_14_0 = ctx.noticeForm.get("notice_date")) == null ? null : tmp_14_0.touched));
      \u0275\u0275advance(20);
...
//# sourceMappingURL=chunk-4SECX7DQ.js.map
