...
var PeriodService = class _PeriodService {
  http;
  constructor(http) {
    this.http = http;
  }
  ...
  updatePeriod(periodId, periodData) {
    return this.http.post(`${environment.apiUrl}/timetable/period-update.php`, __spreadValues({
      period_id: periodId
    }, periodData));
  }
  ...
  static \u0275fac = function PeriodService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _PeriodService)(\u0275\u0275inject(HttpClient));
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _PeriodService, factory: _PeriodService.\u0275fac, providedIn: "root" });
};

// src/app/modules/periods/period-list/period-list.component.ts
var PeriodListComponent = class _PeriodListComponent {
  periodService;
  dialogService;
  toastService;
  exportService;
  ...
  startDate;
  endDate;
  constructor(periodService, dialogService, toastService, exportService, router) {
  ...
  calculateDuration(startTime, endTime) {
    ...
    try {
      ...
      const end = /* @__PURE__ */ new Date(`2000-01-01 ${endTime}`);
  ...
  static \u0275fac = function PeriodListComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _PeriodListComponent)(\u0275\u0275directiveInject(PeriodService), \u0275\u0275directiveInject(DialogService), \u0275\u0275directiveInject(ToastService), \u0275\u0275directiveInject(ExportService), \u0275\u0275directiveInject(Router));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PeriodListComponent, selectors: [["app-period-list"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 8, vars: 11, consts: [[1, "period-list-container"], [1, "page-header"], [1, "page-title"], [1, "page-subtitle"], [3, "pageChange", "pageSizeChange", "searchChange", "sortChange", "dateFilterChange", "rowSelect", "refresh", "addClick", "editClick", "deleteClick", "exportClick", "filterToggle", "data", "columns", "pagination", "loading", "selectedRowId", "rowIdKey", "addRoute", "addLabel", "searchPlaceholder", "enableExport", "enableDateFilter"]], template: function PeriodListComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "div")(3, "h1", 2);
      \u0275\u0275text(4, "Periods");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(5, "p", 3);
      \u0275\u0275text(6, "Manage timetable periods");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(7, "app-enhanced-table", 4);
      \u0275\u0275listener("pageChange", function PeriodListComponent_Template_app_enhanced_table_pageChange_7_listener($event) {
        return ctx.onPageChange($event);
      })("pageSizeChange", function PeriodListComponent_Template_app_enhanced_table_pageSizeChange_7_listener($event) {
        return ctx.onPageSizeChange($event);
      })("searchChange", function PeriodListComponent_Template_app_enhanced_table_searchChange_7_listener($event) {
        return ctx.onSearchChange($event);
      })("sortChange", function PeriodListComponent_Template_app_enhanced_table_sortChange_7_listener($event) {
        return ctx.onSortChange($event);
      })("dateFilterChange", function PeriodListComponent_Template_app_enhanced_table_dateFilterChange_7_listener($event) {
        return ctx.onDateFilterChange($event);
      })("rowSelect", function PeriodListComponent_Template_app_enhanced_table_rowSelect_7_listener($event) {
        return ctx.onRowSelect($event);
      })("refresh", function PeriodListComponent_Template_app_enhanced_table_refresh_7_listener() {
        return ctx.onRefresh();
      })("addClick", function PeriodListComponent_Template_app_enhanced_table_addClick_7_listener() {
        return ctx.onAdd();
      })("editClick", function PeriodListComponent_Template_app_enhanced_table_editClick_7_listener($event) {
        return ctx.onEdit($event);
      })("deleteClick", function PeriodListComponent_Template_app_enhanced_table_deleteClick_7_listener($event) {
        return ctx.onDelete($event);
      })("exportClick", function PeriodListComponent_Template_app_enhanced_table_exportClick_7_listener($event) {
        return ctx.onExportClick($event);
      })("filterToggle", function PeriodListComponent_Template_app_enhanced_table_filterToggle_7_listener($event) {
    ...
    if (rf & 2) {
      \u0275\u0275advance(7);
      \u0275\u0275property("data", ctx.periods)("columns", ctx.columns)("pagination", ctx.pagination)("loading", ctx.loading)("selectedRowId", ctx.selectedRowId)("rowIdKey", "period_id")("addRoute", "/app/periods/create")("addLabel", "Add Period")("searchPlaceholder", "Search periods...")("enableExport", true)("enableDateFilter", true);
    }
  }, dependencies: [CommonModule, FormsModule, RouterModule, EnhancedTableComponent], styles: ["\n\n.period-list-container[_ngcontent-%COMP%] {\n  width: 100%;\n  padding: 0;\n}\n@media (max-width: 768px) {\n  .period-list-container[_ngcontent-%COMP%] {\n    padding: 12px 16px;\n  }\n}\n@media (max-width: 480px) {\n  .period-list-container[_ngcontent-%COMP%] {\n    padding: 8px 12px;\n  }\n}\n.period-list-container[_ngcontent-%COMP%]   .page-header[_ngcontent-%COMP%] {\n  margin-top: 0;\n  flex-direction: column;\n  align-items: flex-start;\n  gap: var(--spacing-md);\n}\n.period-list-container[_ngcontent-%COMP%]   .page-header[_ngcontent-%COMP%]   .page-title[_ngcontent-%COMP%] {\n  font-size: var(--font-size-xl);\n}\n/*# sourceMappingURL=period-list.component.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PeriodListComponent, { className: "PeriodListComponent", filePath: "src\\app\\modules\\periods\\period-list\\period-list.component.ts", lineNumber: 18 });
})();

// src/app/modules/periods/period-create/period-create.component.ts
function PeriodCreateComponent_span_34_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1("", ctx_r0.isEditMode ? "Update" : "Create", " Period");
  }
}
function PeriodCreateComponent_span_35_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275element(1, "span", 18);
    \u0275\u0275text(2, " Saving... ");
...
var PeriodCreateComponent = class _PeriodCreateComponent {
  fb;
  periodService;
  router;
  route;
  ...
  periodId = null;
  isSaving = false;
  constructor(fb, periodService, router, route, toastService) {
    this.fb = fb;
    this.periodService = periodService;
    this.router = router;
    this.route = route;
  ...
  static \u0275fac = function PeriodCreateComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _PeriodCreateComponent)(\u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(PeriodService), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(ToastService));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PeriodCreateComponent, selectors: [["app-period-create"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 36, vars: 6, consts: [[1, "period-create-container"], [1, "page-header"], [1, "page-title"], [1, "page-subtitle"], [1, "btn", "btn-outline", 3, "click"], [1, "bi", "bi-arrow-left"], [1, "form-card"], [3, "ngSubmit", "formGroup"], [1, "form-row"], [1, "form-group"], ["type", "text", "formControlName", "period_name", "placeholder", "e.g., Period 1, First Period", "required", "", 1, "form-control"], ["type", "number", "formControlName", "period_order", "placeholder", "e.g., 1, 2, 3", "min", "1", 1, "form-control"], ["type", "time", "formControlName", "start_time", "required", "", 1, "form-control"], ["type", "time", "formControlName", "end_time", "required", "", 1, "form-control"], [1, "form-actions"], ["type", "button", 1, "btn", "btn-outline", 3, "click"], ["type", "submit", 1, "btn", "btn-primary", 3, "disabled"], [4, "ngIf"], [1, "spinner-small"]], template: function PeriodCreateComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "div")(3, "h1", 2);
      \u0275\u0275text(4);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275listener("click", function PeriodCreateComponent_Template_button_click_7_listener() {
        return ctx.router.navigate(["/app/periods"]);
      });
      \u0275\u0275element(8, "i", 5);
      \u0275\u0275text(9, " Back ");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(10, "div", 6)(11, "form", 7);
      \u0275\u0275listener("ngSubmit", function PeriodCreateComponent_Template_form_ngSubmit_11_listener() {
        return ctx.onSubmit();
      });
      \u0275\u0275elementStart(12, "div", 8)(13, "div", 9)(14, "label");
      \u0275\u0275text(15, "Period Name *");
      \u0275\u0275elementEnd();
      \u0275\u0275element(16, "input", 10);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(17, "div", 9)(18, "label");
      \u0275\u0275text(19, "Period Order");
      \u0275\u0275elementEnd();
...
//# sourceMappingURL=chunk-MCWR7S32.js.map
