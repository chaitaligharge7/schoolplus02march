...
// src/app/modules/homework/homework-list/homework-list.component.ts
function HomeworkListComponent_option_14_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(cls_r1.class_name);
  }
}
function HomeworkListComponent_option_21_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 7);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
var HomeworkListComponent = class _HomeworkListComponent {
  homeworkService;
  classService;
  subjectService;
  dialogService;
  ...
  columns = [
    ...
    },
    {
      ...
      format: (value, row) => {
        ...
        const isOverdue = date < /* @__PURE__ */ new Date() && row?.status !== "completed";
    ...
    },
    {
      ...
      sortable: true,
      format: (value) => {
        const badgeClass = value === "completed" ? "badge-success" : value === "expired" ? "badge-danger" : "badge-warning";
  ...
  subjectId;
  status;
  constructor(homeworkService, classService, subjectService, dialogService, toastService, exportService, router) {
  ...
  static \u0275fac = function HomeworkListComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _HomeworkListComponent)(\u0275\u0275directiveInject(HomeworkService), \u0275\u0275directiveInject(ClassService), \u0275\u0275directiveInject(SubjectService), \u0275\u0275directiveInject(DialogService), \u0275\u0275directiveInject(ToastService), \u0275\u0275directiveInject(ExportService), \u0275\u0275directiveInject(Router));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HomeworkListComponent, selectors: [["app-homework-list"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 35, vars: 21, consts: [[1, "homework-list-container"], [1, "page-header"], [1, "page-title"], [1, "page-subtitle"], [1, "additional-filters", "filter-panel"], [1, "filter-group"], [1, "form-control", 3, "ngModelChange", "change", "ngModel"], [3, "value"], [3, "value", 4, "ngFor", "ngForOf"], ["value", "active"], ["value", "completed"], ["value", "expired"], [3, "pageChange", "pageSizeChange", "searchChange", "sortChange", "dateFilterChange", "rowSelect", "refresh", "addClick", "editClick", "deleteClick", "exportClick", "filterToggle", "data", "columns", "pagination", "loading", "selectedRowId", "rowIdKey", "addRoute", "addLabel", "searchPlaceholder", "enableExport", "enableDateFilter"]], template: function HomeworkListComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "div")(3, "h1", 2);
      \u0275\u0275text(4, "Homework & Assignments");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(5, "p", 3);
      \u0275\u0275text(6, "Manage homework and assignments for students");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(7, "div", 4)(8, "div", 5)(9, "label");
      \u0275\u0275text(10, "Class:");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(11, "select", 6);
      \u0275\u0275twoWayListener("ngModelChange", function HomeworkListComponent_Template_select_ngModelChange_11_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.classId, $event) || (ctx.classId = $event);
        return $event;
      });
      \u0275\u0275listener("change", function HomeworkListComponent_Template_select_change_11_listener() {
        return ctx.onClassChange(ctx.classId);
      });
      \u0275\u0275elementStart(12, "option", 7);
      \u0275\u0275text(13, "All Classes");
      \u0275\u0275elementEnd();
      \u0275\u0275template(14, HomeworkListComponent_option_14_Template, 2, 2, "option", 8);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(15, "div", 5)(16, "label");
      \u0275\u0275text(17, "Subject:");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(18, "select", 6);
      \u0275\u0275twoWayListener("ngModelChange", function HomeworkListComponent_Template_select_ngModelChange_18_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.subjectId, $event) || (ctx.subjectId = $event);
        return $event;
      });
      \u0275\u0275listener("change", function HomeworkListComponent_Template_select_change_18_listener() {
        return ctx.onSubjectChange(ctx.subjectId);
      });
      \u0275\u0275elementStart(19, "option", 7);
      \u0275\u0275text(20, "All Subjects");
      \u0275\u0275elementEnd();
      \u0275\u0275template(21, HomeworkListComponent_option_21_Template, 2, 2, "option", 8);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(22, "div", 5)(23, "label");
      \u0275\u0275text(24, "Status:");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(25, "select", 6);
      \u0275\u0275twoWayListener("ngModelChange", function HomeworkListComponent_Template_select_ngModelChange_25_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.status, $event) || (ctx.status = $event);
        return $event;
      });
      \u0275\u0275listener("change", function HomeworkListComponent_Template_select_change_25_listener() {
      ...
      \u0275\u0275text(33, "Expired");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(34, "app-enhanced-table", 12);
      \u0275\u0275listener("pageChange", function HomeworkListComponent_Template_app_enhanced_table_pageChange_34_listener($event) {
        return ctx.onPageChange($event);
      })("pageSizeChange", function HomeworkListComponent_Template_app_enhanced_table_pageSizeChange_34_listener($event) {
        return ctx.onPageSizeChange($event);
      })("searchChange", function HomeworkListComponent_Template_app_enhanced_table_searchChange_34_listener($event) {
        return ctx.onSearchChange($event);
      })("sortChange", function HomeworkListComponent_Template_app_enhanced_table_sortChange_34_listener($event) {
        return ctx.onSortChange($event);
      })("dateFilterChange", function HomeworkListComponent_Template_app_enhanced_table_dateFilterChange_34_listener($event) {
        return ctx.onDateFilterChange($event);
      })("rowSelect", function HomeworkListComponent_Template_app_enhanced_table_rowSelect_34_listener($event) {
        return ctx.onRowSelect($event);
      })("refresh", function HomeworkListComponent_Template_app_enhanced_table_refresh_34_listener() {
        return ctx.onRefresh();
      })("addClick", function HomeworkListComponent_Template_app_enhanced_table_addClick_34_listener() {
        return ctx.onAdd();
      })("editClick", function HomeworkListComponent_Template_app_enhanced_table_editClick_34_listener($event) {
        return ctx.onEdit($event);
      })("deleteClick", function HomeworkListComponent_Template_app_enhanced_table_deleteClick_34_listener($event) {
        return ctx.onDelete($event);
      })("exportClick", function HomeworkListComponent_Template_app_enhanced_table_exportClick_34_listener($event) {
        return ctx.onExportClick($event);
      })("filterToggle", function HomeworkListComponent_Template_app_enhanced_table_filterToggle_34_listener($event) {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275property("value", void 0);
      \u0275\u0275advance(8);
      \u0275\u0275property("data", ctx.homeworks)("columns", ctx.columns)("pagination", ctx.pagination)("loading", ctx.loading)("selectedRowId", ctx.selectedRowId)("rowIdKey", "homework_id")("addRoute", "/app/homework/create")("addLabel", "Create Homework")("searchPlaceholder", "Search by title, description...")("enableExport", true)("enableDateFilter", true);
    }
  }, dependencies: [CommonModule, NgForOf, FormsModule, NgSelectOption, \u0275NgSelectMultipleOption, SelectControlValueAccessor, NgControlStatus, NgModel, RouterModule, EnhancedTableComponent], styles: ["\n\n.homework-list-container[_ngcontent-%COMP%] {\n  width: 100%;\n  padding: 0;\n}\n@media (max-width: 768px) {\n  .homework-list-container[_ngcontent-%COMP%] {\n    padding: 12px 16px;\n  }\n}\n@media (max-width: 480px) {\n  .homework-list-container[_ngcontent-%COMP%] {\n    padding: 8px 12px;\n  }\n}\n.homework-list-container[_ngcontent-%COMP%]   .page-header[_ngcontent-%COMP%] {\n  margin-top: 0;\n  flex-direction: column;\n  align-items: flex-start;\n  gap: var(--spacing-md);\n}\n.homework-list-container[_ngcontent-%COMP%]   .page-header[_ngcontent-%COMP%]   .page-title[_ngcontent-%COMP%] {\n  font-size: var(--font-size-xl);\n}\n.homework-list-container[_ngcontent-%COMP%]   .additional-filters[_ngcontent-%COMP%] {\n  display: flex;\n  gap: var(--spacing-md);\n  margin-bottom: var(--spacing-lg);\n  padding: var(--spacing-md);\n  background: var(--bg-secondary);\n  border-radius: var(--radius-md);\n  flex-wrap: wrap;\n  align-items: end;\n}\n.homework-list-container[_ngcontent-%COMP%]   .additional-filters[_ngcontent-%COMP%]   .filter-group[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: var(--spacing-xs);\n  min-width: 150px;\n}\n.homework-list-container[_ngcontent-%COMP%]   .additional-filters[_ngcontent-%COMP%]   .filter-group[_ngcontent-%COMP%]   label[_ngcontent-%COMP%] {\n  font-size: var(--font-size-sm);\n  font-weight: 500;\n  color: var(--text-secondary);\n}\n.homework-list-container[_ngcontent-%COMP%]   .additional-filters[_ngcontent-%COMP%]   .filter-group[_ngcontent-%COMP%]   .form-control[_ngcontent-%COMP%] {\n  padding: var(--spacing-sm) var(--spacing-md);\n  border: 1px solid var(--border-color);\n  border-radius: var(--radius-md);\n  background: var(--bg-primary);\n  color: var(--text-primary);\n  font-size: var(--font-size-sm);\n  transition: all var(--transition-base);\n}\n.homework-list-container[_ngcontent-%COMP%]   .additional-filters[_ngcontent-%COMP%]   .filter-group[_ngcontent-%COMP%]   .form-control[_ngcontent-%COMP%]:focus {\n  outline: none;\n  border-color: var(--primary-color);\n  box-shadow: 0 0 0 3px rgba(37, 99, 235, 0.1);\n}\n/*# sourceMappingURL=homework-list.component.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(HomeworkListComponent, { className: "HomeworkListComponent", filePath: "src\\app\\modules\\homework\\homework-list\\homework-list.component.ts", lineNumber: 20 });
})();

// src/app/modules/homework/homework-create/homework-create.component.ts
function HomeworkCreateComponent_option_23_Template(rf, ctx) {
  if (rf & 1) {
...
function HomeworkCreateComponent_option_30_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 12);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function HomeworkCreateComponent_option_37_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "option", 12);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function HomeworkCreateComponent_span_59_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1("", ctx_r3.isEditMode ? "Update" : "Create", " Homework");
  }
}
function HomeworkCreateComponent_span_60_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275element(1, "span", 24);
    \u0275\u0275text(2, " Saving... ");
...
var HomeworkCreateComponent = class _HomeworkCreateComponent {
  fb;
  homeworkService;
  classService;
  router;
  ...
  sections = [];
  subjects = [];
  constructor(fb, homeworkService, classService, router, route) {
    this.fb = fb;
    this.homeworkService = homeworkService;
    this.classService = classService;
    this.router = router;
  ...
  static \u0275fac = function HomeworkCreateComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _HomeworkCreateComponent)(\u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(HomeworkService), \u0275\u0275directiveInject(ClassService), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(ActivatedRoute));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HomeworkCreateComponent, selectors: [["app-homework-create"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 61, vars: 12, consts: [[1, "homework-create-container"], [1, "page-header"], [1, "page-title"], [1, "page-subtitle"], [1, "btn", "btn-outline", 3, "click"], [1, "bi", "bi-arrow-left"], [1, "form-card"], [3, "ngSubmit", "formGroup"], [1, "form-group"], ["type", "text", "formControlName", "homework_title", "placeholder", "Enter homework title", "required", "", 1, "form-control"], [1, "form-row"], ["formControlName", "class_id", "required", "", 1, "form-control"], [3, "value"], [3, "value", 4, "ngFor", "ngForOf"], ["formControlName", "section_id", 1, "form-control"], ["formControlName", "subject_id", "required", "", 1, "form-control"], ["type", "date", "formControlName", "assigned_date", "required", "", 1, "form-control"], ["type", "date", "formControlName", "due_date", "required", "", 1, "form-control"], ["type", "number", "formControlName", "max_marks", "placeholder", "Enter maximum marks (optional)", "min", "0", "step", "0.01", 1, "form-control"], ["formControlName", "description", "rows", "5", "placeholder", "Enter homework description and instructions...", 1, "form-control"], [1, "form-actions"], ["type", "button", 1, "btn", "btn-outline", 3, "click"], ["type", "submit", 1, "btn", "btn-primary", 3, "disabled"], [4, "ngIf"], [1, "spinner-small"]], template: function HomeworkCreateComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "div")(3, "h1", 2);
      \u0275\u0275text(4);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275listener("click", function HomeworkCreateComponent_Template_button_click_7_listener() {
        return ctx.router.navigate(["/app/homework"]);
      });
      \u0275\u0275element(8, "i", 5);
      \u0275\u0275text(9, " Back ");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(10, "div", 6)(11, "form", 7);
      \u0275\u0275listener("ngSubmit", function HomeworkCreateComponent_Template_form_ngSubmit_11_listener() {
        return ctx.onSubmit();
      });
      \u0275\u0275elementStart(12, "div", 8)(13, "label");
      \u0275\u0275text(14, "Homework Title *");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275text(22, "Select Class");
      \u0275\u0275elementEnd();
      \u0275\u0275template(23, HomeworkCreateComponent_option_23_Template, 2, 2, "option", 13);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(24, "div", 8)(25, "label");
      \u0275\u0275text(26, "Section");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(27, "select", 14)(28, "option", 12);
      \u0275\u0275text(29, "All Sections");
      \u0275\u0275elementEnd();
      \u0275\u0275template(30, HomeworkCreateComponent_option_30_Template, 2, 2, "option", 13);
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(31, "div", 8)(32, "label");
      \u0275\u0275text(33, "Subject *");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(34, "select", 15)(35, "option", 12);
      \u0275\u0275text(36, "Select Subject");
      \u0275\u0275elementEnd();
      \u0275\u0275template(37, HomeworkCreateComponent_option_37_Template, 2, 2, "option", 13);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(38, "div", 10)(39, "div", 8)(40, "label");
      \u0275\u0275text(41, "Assigned Date *");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(47, "div", 8)(48, "label");
      \u0275\u0275text(49, "Maximum Marks");
      \u0275\u0275elementEnd();
      \u0275\u0275element(50, "input", 18);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(51, "div", 8)(52, "label");
      \u0275\u0275text(53, "Description");
      \u0275\u0275elementEnd();
      \u0275\u0275element(54, "textarea", 19);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(55, "div", 20)(56, "button", 21);
      \u0275\u0275listener("click", function HomeworkCreateComponent_Template_button_click_56_listener() {
        return ctx.router.navigate(["/app/homework"]);
      });
      \u0275\u0275text(57, " Cancel ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(58, "button", 22);
      \u0275\u0275template(59, HomeworkCreateComponent_span_59_Template, 2, 1, "span", 23)(60, HomeworkCreateComponent_span_60_Template, 3, 0, "span", 23);
      \u0275\u0275elementEnd()()()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(ctx.isEditMode ? "Edit Homework" : "Create Homework");
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate(ctx.isEditMode ? "Update homework details" : "Assign new homework to students");
      \u0275\u0275advance(5);
      \u0275\u0275property("formGroup", ctx.homeworkForm);
      \u0275\u0275advance(10);
...
//# sourceMappingURL=chunk-AJYJ6Z6O.js.map
