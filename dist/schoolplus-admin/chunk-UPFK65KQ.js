...
var ConfirmDialogComponent = class _ConfirmDialogComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConfirmDialogComponent, selectors: [["app-confirm-dialog"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 14, vars: 18, consts: [[1, "confirm-dialog"], [1, "dialog-header"], [1, "dialog-icon"], [1, "dialog-title"], [1, "dialog-content"], [1, "dialog-actions"], [1, "btn", "btn-outline", 3, "click"], [1, "btn", 3, "click"]], template: function ConfirmDialogComponent_Template(rf, ctx) {
    if (rf & 1) {
    ...
    if (rf & 2) {
      \u0275\u0275advance(2);
      \u0275\u0275classProp("icon-warning", ctx.data.type === "warning")("icon-danger", ctx.data.type === "danger")("icon-info", ctx.data.type === "info");
      \u0275\u0275advance();
      \u0275\u0275classMap(ctx.getIconClass());
      \u0275\u0275advance(2);
...
var DialogService = class _DialogService {
  ...
  confirm(dataOrTitle, message, confirmText, cancelText) {
    let data;
...
//# sourceMappingURL=chunk-UPFK65KQ.js.map
