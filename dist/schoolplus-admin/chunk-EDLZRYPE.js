...
// src/app/shared/components/convert-enquiry-dialog/convert-enquiry-dialog.component.ts
function ConvertEnquiryDialogComponent_ng_container_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function ConvertEnquiryDialogComponent_ng_container_7_Template_button_click_4_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.convertToAdmission());
    });
    \u0275\u0275element(5, "i", 10);
    \u0275\u0275text(6, " Convert to Admission ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "button", 11);
    \u0275\u0275listener("click", function ConvertEnquiryDialogComponent_ng_container_7_Template_button_click_7_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.chooseAllotCounsellor());
    });
    \u0275\u0275element(8, "i", 12);
    \u0275\u0275text(9, " Allot Counsellor ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("Choose an action for ", ctx_r1.data.studentName || "this student", ".");
  }
}
function ConvertEnquiryDialogComponent_ng_container_8_option_9_Template(rf, ctx) {
  if (rf & 1) {
...
function ConvertEnquiryDialogComponent_ng_container_8_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275elementStart(1, "p");
    \u0275\u0275text(2, "Select a counsellor to assign this lead to. They will receive a notification.");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 13)(4, "label");
    \u0275\u0275text(5, "Counsellor");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "select", 14);
    \u0275\u0275twoWayListener("ngModelChange", function ConvertEnquiryDialogComponent_ng_container_8_Template_select_ngModelChange_6_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r1.selectedCounselorId, $event) || (ctx_r1.selectedCounselorId = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275elementStart(7, "option", 15);
    \u0275\u0275text(8, "Select counsellor");
    \u0275\u0275elementEnd();
    \u0275\u0275template(9, ConvertEnquiryDialogComponent_ng_container_8_option_9_Template, 2, 3, "option", 16);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(10, "div", 17)(11, "button", 18);
    \u0275\u0275listener("click", function ConvertEnquiryDialogComponent_ng_container_8_Template_button_click_11_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function ConvertEnquiryDialogComponent_ng_container_8_Template_button_click_13_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.confirmAllot());
    });
    \u0275\u0275text(14, " Allot & Notify ");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(6);
    \u0275\u0275twoWayProperty("ngModel", ctx_r1.selectedCounselorId);
    \u0275\u0275advance();
    \u0275\u0275property("value", null);
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", ctx_r1.data.counselors);
    \u0275\u0275advance(4);
    \u0275\u0275property("disabled", !ctx_r1.selectedCounselorId);
  }
}
function ConvertEnquiryDialogComponent_div_9_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 17)(1, "button", 18);
    \u0275\u0275listener("click", function ConvertEnquiryDialogComponent_div_9_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext();
...
var ConvertEnquiryDialogComponent = class _ConvertEnquiryDialogComponent {
  dialogRef;
  data;
  step = "choice";
  ...
  static \u0275fac = function ConvertEnquiryDialogComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _ConvertEnquiryDialogComponent)(\u0275\u0275directiveInject(MatDialogRef), \u0275\u0275directiveInject(MAT_DIALOG_DATA));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConvertEnquiryDialogComponent, selectors: [["app-convert-enquiry-dialog"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 10, vars: 4, consts: [[1, "convert-enquiry-dialog"], [1, "dialog-header"], [1, "dialog-icon", "icon-info"], [1, "bi", "bi-info-circle-fill"], [1, "dialog-title"], [1, "dialog-content"], [4, "ngIf"], ["class", "dialog-actions", 4, "ngIf"], [1, "dialog-actions", "vertical"], ["type", "button", 1, "btn", "btn-primary", "full-width", 3, "click"], [1, "bi", "bi-person-plus"], ["type", "button", 1, "btn", "btn-outline", "full-width", 3, "click"], [1, "bi", "bi-person-workspace"], [1, "form-group"], ["name", "counselor_id", 1, "form-control", 3, "ngModelChange", "ngModel"], [3, "value"], [3, "value", 4, "ngFor", "ngForOf"], [1, "dialog-actions"], ["type", "button", 1, "btn", "btn-outline", 3, "click"], ["type", "button", 1, "btn", "btn-primary", 3, "click", "disabled"]], template: function ConvertEnquiryDialogComponent_Template(rf, ctx) {
    if (rf & 1) {
...
var QrCodeDialogComponent = class _QrCodeDialogComponent {
  ...
  static \u0275fac = function QrCodeDialogComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _QrCodeDialogComponent)(\u0275\u0275directiveInject(MatDialogRef), \u0275\u0275directiveInject(MAT_DIALOG_DATA));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _QrCodeDialogComponent, selectors: [["app-qr-code-dialog"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 11, vars: 4, consts: [[1, "qr-dialog"], [1, "qr-title"], [1, "qr-url"], ["alt", "QR Code", 1, "qr-image", 3, "src"], [1, "qr-actions"], ["download", "visitor-enquiry-qr.png", 1, "btn", "btn-primary", 3, "href"], ["type", "button", 1, "btn", "btn-outline", 3, "click"]], template: function QrCodeDialogComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(8, "Download QR Code");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(9, "button", 6);
      \u0275\u0275listener("click", function QrCodeDialogComponent_Template_button_click_9_listener() {
        return ctx.close();
      });
      \u0275\u0275text(10, "Close");
      \u0275\u0275elementEnd()()();
    ...
    if (rf & 2) {
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate(ctx.data.title || "QR Code");
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate(ctx.data.url);
      \u0275\u0275advance();
      \u0275\u0275property("src", ctx.qrImageUrl, \u0275\u0275sanitizeUrl);
      \u0275\u0275advance(2);
      \u0275\u0275property("href", ctx.qrImageUrl, \u0275\u0275sanitizeUrl);
    }
  }, dependencies: [CommonModule, MatDialogModule], styles: ["\n\n.qr-dialog[_ngcontent-%COMP%] {\n  padding: 1.25rem;\n  text-align: center;\n}\n.qr-title[_ngcontent-%COMP%] {\n  margin: 0 0 0.5rem 0;\n  font-size: 1.25rem;\n}\n.qr-url[_ngcontent-%COMP%] {\n  font-size: 0.75rem;\n  color: #64748b;\n  word-break: break-all;\n  margin-bottom: 1rem;\n}\n.qr-image[_ngcontent-%COMP%] {\n  display: block;\n  margin: 0 auto 1rem;\n  max-width: 280px;\n  height: auto;\n}\n.qr-actions[_ngcontent-%COMP%] {\n  display: flex;\n  gap: 0.75rem;\n  justify-content: center;\n  flex-wrap: wrap;\n}\n.btn[_ngcontent-%COMP%] {\n  padding: 0.5rem 1rem;\n  border-radius: 0.5rem;\n  text-decoration: none;\n  font-size: 0.875rem;\n  cursor: pointer;\n  border: none;\n}\n.btn-primary[_ngcontent-%COMP%] {\n  background: #2563eb;\n  color: #fff;\n}\n.btn-outline[_ngcontent-%COMP%] {\n  background: transparent;\n  border: 1px solid #e2e8f0;\n  color: #374151;\n}\n/*# sourceMappingURL=qr-code-dialog.component.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(QrCodeDialogComponent, { className: "QrCodeDialogComponent", filePath: "src\\app\\shared\\components\\qr-code-dialog\\qr-code-dialog.component.ts", lineNumber: 36 });
})();

// src/app/modules/enquiries/enquiry-list/enquiry-list.component.ts
function EnquiryListComponent_div_20_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 12)(1, "button", 13);
    \u0275\u0275listener("click", function EnquiryListComponent_div_20_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.convertToAdmission(ctx_r1.getSelectedEnquiry()));
    });
    \u0275\u0275element(2, "i", 14);
    \u0275\u0275text(3, " Convert to Admission ");
    \u0275\u0275elementEnd()();
  }
}
var EnquiryListComponent = class _EnquiryListComponent {
  enquiryService;
  classService;
  receptionistService;
  dialog;
  ...
  columns = [
    ...
    },
    {
      ...
      sortable: true,
      format: (value) => {
        const badgeClass = value === "converted" ? "badge-success" : value === "pending" ? "badge-warning" : "badge-danger";
  ...
  conversionStatus;
  enquirySource;
  enquiryConversionStatusOptions = [
  ...
  enquirySourceOptions = [
    { value: void 0, label: "All Sources" },
    { value: "online", label: "Online" },
    { value: "walk-in", label: "Walk-in" },
    { value: "referral", label: "Referral" }
  ];
  counselors = [];
  constructor(enquiryService, classService, receptionistService, dialog, dialogService, toastService, exportService, router) {
  ...
  onConversionStatusChange(status) {
    this.conversionStatus = status || void 0;
    this.pagination.page = 1;
    this.loadEnquiries();
  }
  onEnquirySourceChange(source) {
    this.enquirySource = source || void 0;
    this.pagination.page = 1;
    this.loadEnquiries();
  }
  openQrCodeDialog() {
  ...
  static \u0275fac = function EnquiryListComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _EnquiryListComponent)(\u0275\u0275directiveInject(EnquiryService), \u0275\u0275directiveInject(ClassService), \u0275\u0275directiveInject(ReceptionistService), \u0275\u0275directiveInject(MatDialog), \u0275\u0275directiveInject(DialogService), \u0275\u0275directiveInject(ToastService), \u0275\u0275directiveInject(ExportService), \u0275\u0275directiveInject(Router));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EnquiryListComponent, selectors: [["app-enquiry-list"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 21, vars: 20, consts: [[1, "enquiry-list-container"], [1, "page-header", "enquiry-list-header"], [1, "page-title"], [1, "page-subtitle"], ["type", "button", "title", "Generate QR code for visitor enquiry form", 1, "btn", "btn-outline", 3, "click"], [1, "bi", "bi-qr-code"], [1, "additional-filters", "filter-panel"], [1, "filter-group"], ["placeholder", "Search or select status", 3, "ngModelChange", "valueChange", "options", "ngModel"], ["placeholder", "Search or select source", 3, "ngModelChange", "valueChange", "options", "ngModel"], [3, "pageChange", "pageSizeChange", "searchChange", "sortChange", "dateFilterChange", "rowSelect", "refresh", "addClick", "viewClick", "convertClick", "editClick", "exportClick", "filterToggle", "data", "columns", "pagination", "loading", "selectedRowId", "rowIdKey", "addRoute", "addLabel", "searchPlaceholder", "enableExport", "enableDateFilter", "showViewButton", "showConvertButton"], ["class", "convert-action", 4, "ngIf"], [1, "convert-action"], ["title", "Convert to Admission", 1, "btn", "btn-success", 3, "click"], [1, "bi", "bi-check-circle"]], template: function EnquiryListComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "div")(3, "h1", 2);
      \u0275\u0275text(4, "Enquiry Management");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(5, "p", 3);
      \u0275\u0275text(6, "Manage student enquiries and convert to admissions");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(7, "button", 4);
      \u0275\u0275listener("click", function EnquiryListComponent_Template_button_click_7_listener() {
        return ctx.openQrCodeDialog();
      });
      \u0275\u0275element(8, "i", 5);
      \u0275\u0275text(9, " Generate QR Code ");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(10, "div", 6)(11, "div", 7)(12, "label");
      \u0275\u0275text(13, "Status:");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(14, "app-search-select", 8);
      \u0275\u0275twoWayListener("ngModelChange", function EnquiryListComponent_Template_app_search_select_ngModelChange_14_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.conversionStatus, $event) || (ctx.conversionStatus = $event);
        return $event;
      });
      \u0275\u0275listener("valueChange", function EnquiryListComponent_Template_app_search_select_valueChange_14_listener($event) {
        return ctx.onConversionStatusChange($event);
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(15, "div", 7)(16, "label");
      \u0275\u0275text(17, "Source:");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(18, "app-search-select", 9);
      \u0275\u0275twoWayListener("ngModelChange", function EnquiryListComponent_Template_app_search_select_ngModelChange_18_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.enquirySource, $event) || (ctx.enquirySource = $event);
        return $event;
      });
      \u0275\u0275listener("valueChange", function EnquiryListComponent_Template_app_search_select_valueChange_18_listener($event) {
        return ctx.onEnquirySourceChange($event);
      });
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(19, "app-enhanced-table", 10);
      \u0275\u0275listener("pageChange", function EnquiryListComponent_Template_app_enhanced_table_pageChange_19_listener($event) {
        return ctx.onPageChange($event);
      })("pageSizeChange", function EnquiryListComponent_Template_app_enhanced_table_pageSizeChange_19_listener($event) {
        return ctx.onPageSizeChange($event);
      })("searchChange", function EnquiryListComponent_Template_app_enhanced_table_searchChange_19_listener($event) {
        return ctx.onSearchChange($event);
      })("sortChange", function EnquiryListComponent_Template_app_enhanced_table_sortChange_19_listener($event) {
        return ctx.onSortChange($event);
      })("dateFilterChange", function EnquiryListComponent_Template_app_enhanced_table_dateFilterChange_19_listener($event) {
        return ctx.onDateFilterChange($event);
      })("rowSelect", function EnquiryListComponent_Template_app_enhanced_table_rowSelect_19_listener($event) {
        return ctx.onRowSelect($event);
      })("refresh", function EnquiryListComponent_Template_app_enhanced_table_refresh_19_listener() {
        return ctx.onRefresh();
      })("addClick", function EnquiryListComponent_Template_app_enhanced_table_addClick_19_listener() {
        return ctx.onAdd();
      })("viewClick", function EnquiryListComponent_Template_app_enhanced_table_viewClick_19_listener($event) {
        return ctx.onView($event);
      })("convertClick", function EnquiryListComponent_Template_app_enhanced_table_convertClick_19_listener($event) {
        return ctx.convertToAdmission($event);
      })("editClick", function EnquiryListComponent_Template_app_enhanced_table_editClick_19_listener($event) {
        return ctx.onEdit($event);
      })("exportClick", function EnquiryListComponent_Template_app_enhanced_table_exportClick_19_listener($event) {
        return ctx.onExportClick($event);
      })("filterToggle", function EnquiryListComponent_Template_app_enhanced_table_filterToggle_19_listener($event) {
        return ctx.onFilterToggle($event);
      });
      \u0275\u0275elementEnd();
      \u0275\u0275template(20, EnquiryListComponent_div_20_Template, 4, 0, "div", 11);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      let tmp_18_0;
      ...
      \u0275\u0275advance(4);
      \u0275\u0275property("options", ctx.enquiryConversionStatusOptions);
      \u0275\u0275twoWayProperty("ngModel", ctx.conversionStatus);
      \u0275\u0275advance(4);
      \u0275\u0275property("options", ctx.enquirySourceOptions);
      \u0275\u0275twoWayProperty("ngModel", ctx.enquirySource);
      \u0275\u0275advance();
      \u0275\u0275property("data", ctx.enquiries)("columns", ctx.columns)("pagination", ctx.pagination)("loading", ctx.loading)("selectedRowId", ctx.selectedRowId)("rowIdKey", "enquiry_id")("addRoute", "/app/enquiries/create")("addLabel", "Add Enquiry")("searchPlaceholder", "Search by name, mobile, enquiry number...")("enableExport", true)("enableDateFilter", true)("showViewButton", true)("showConvertButton", true);
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ctx.selectedRowId && ctx.getSelectedEnquiry() && ((tmp_18_0 = ctx.getSelectedEnquiry()) == null ? null : tmp_18_0.conversion_status) === "pending");
    }
  }, dependencies: [CommonModule, NgIf, FormsModule, NgControlStatus, NgModel, RouterModule, MatDialogModule, EnhancedTableComponent, SearchSelectComponent], styles: ["\n\n.enquiry-list-container[_ngcontent-%COMP%] {\n  width: 100%;\n  padding: 0;\n}\n@media (max-width: 768px) {\n  .enquiry-list-container[_ngcontent-%COMP%] {\n    padding: 12px 16px;\n  }\n}\n@media (max-width: 480px) {\n  .enquiry-list-container[_ngcontent-%COMP%] {\n    padding: 8px 12px;\n  }\n}\n.enquiry-list-container[_ngcontent-%COMP%]   .page-header[_ngcontent-%COMP%] {\n  margin-top: 0;\n  flex-direction: column;\n  align-items: flex-start;\n  gap: var(--spacing-md);\n}\n.enquiry-list-container[_ngcontent-%COMP%]   .page-header.enquiry-list-header[_ngcontent-%COMP%] {\n  flex-direction: row;\n  justify-content: space-between;\n  align-items: center;\n  flex-wrap: wrap;\n}\n.enquiry-list-container[_ngcontent-%COMP%]   .page-header[_ngcontent-%COMP%]   .page-title[_ngcontent-%COMP%] {\n  font-size: var(--font-size-xl);\n}\n.enquiry-list-container[_ngcontent-%COMP%]   .page-header[_ngcontent-%COMP%]   .btn[_ngcontent-%COMP%] {\n  display: inline-flex;\n  align-items: center;\n  gap: var(--spacing-sm);\n  padding: var(--spacing-sm) var(--spacing-md);\n  border-radius: var(--radius-md);\n  font-size: var(--font-size-sm);\n  cursor: pointer;\n}\n.enquiry-list-container[_ngcontent-%COMP%]   .page-header[_ngcontent-%COMP%]   .btn.btn-outline[_ngcontent-%COMP%] {\n  background: transparent;\n  border: 1px solid var(--border-color);\n  color: var(--text-primary);\n}\n.enquiry-list-container[_ngcontent-%COMP%]   .additional-filters[_ngcontent-%COMP%] {\n  display: flex;\n  gap: var(--spacing-md);\n  margin-bottom: var(--spacing-lg);\n  padding: var(--spacing-md);\n  background: var(--bg-secondary);\n  border-radius: var(--radius-md);\n  flex-wrap: wrap;\n  align-items: end;\n}\n.enquiry-list-container[_ngcontent-%COMP%]   .additional-filters[_ngcontent-%COMP%]   .filter-group[_ngcontent-%COMP%] {\n  display: flex;\n  flex-direction: column;\n  gap: var(--spacing-xs);\n  min-width: 150px;\n}\n.enquiry-list-container[_ngcontent-%COMP%]   .additional-filters[_ngcontent-%COMP%]   .filter-group[_ngcontent-%COMP%]   label[_ngcontent-%COMP%] {\n  font-size: var(--font-size-sm);\n  font-weight: 500;\n  color: var(--text-secondary);\n}\n.enquiry-list-container[_ngcontent-%COMP%]   .additional-filters[_ngcontent-%COMP%]   .filter-group[_ngcontent-%COMP%]   .form-control[_ngcontent-%COMP%] {\n  padding: var(--spacing-sm) var(--spacing-md);\n  border: 1px solid var(--border-color);\n  border-radius: var(--radius-md);\n  background: var(--bg-primary);\n  color: var(--text-primary);\n  font-size: var(--font-size-sm);\n  transition: all var(--transition-base);\n}\n.enquiry-list-container[_ngcontent-%COMP%]   .additional-filters[_ngcontent-%COMP%]   .filter-group[_ngcontent-%COMP%]   .form-control[_ngcontent-%COMP%]:focus {\n  outline: none;\n  border-color: var(--primary-color);\n  box-shadow: 0 0 0 3px rgba(37, 99, 235, 0.1);\n}\n.enquiry-list-container[_ngcontent-%COMP%]   .convert-action[_ngcontent-%COMP%] {\n  margin-top: var(--spacing-md);\n  padding: var(--spacing-md);\n  background: var(--bg-secondary);\n  border-radius: var(--radius-md);\n  display: flex;\n  justify-content: center;\n}\n/*# sourceMappingURL=enquiry-list.component.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EnquiryListComponent, { className: "EnquiryListComponent", filePath: "src\\app\\modules\\enquiries\\enquiry-list\\enquiry-list.component.ts", lineNumber: 24 });
})();
export {
  EnquiryListComponent
};
//# sourceMappingURL=chunk-EDLZRYPE.js.map
